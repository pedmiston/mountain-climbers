...
read_graphviz_chunk("guessing-strategies", "mountainclimbers")
```

```{r mountain-climbers-setup, include=FALSE}
```
...
```{r guessing-strategies, engine="dot", fig.width=5, cache=FALSE}
```
